...
| `nuclei` | Broad active vulnerability verification with built-in out-of-band checks. | standard | [projectdiscovery/nuclei](https://github.com/projectdiscovery/nuclei) |
