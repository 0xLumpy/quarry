...
REGISTRY = {
    ...
    "origin": (origin.run, "Origin-IP correlation (CDN de-fronting candidates, map-only)", True),
...
ORDER = ["horizontal", "vertical", "dns", "probe", "crawl", "enrich", "origin", "content", "params"]
